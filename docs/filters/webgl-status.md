...
| Comicize | `Comicize` | `comicize-filter.js` | CPU only | Gamma-RGB Gaussian/Darken Color Brush plus original-image tile geometry, brushed-color dot targets, compatibility quantization, and final fade require several deterministic passes. |
